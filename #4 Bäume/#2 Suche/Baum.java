public class Baum
{
    ...
    public void sucheName(String name)
    {
        String result = erster.sucheName(name);

        if (result.length() != 0)
        {
            System.out.println("Folgende IDs haben den Namen '"
                + name
                + "': "
                + result);
        }
        ...
        {
            System.out.println("Keine ID hat den Namen '"
                + name
                + "'.");
        }
    }
